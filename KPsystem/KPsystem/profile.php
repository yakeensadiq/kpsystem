        ...
        <div id="page-wrapper">
            ...
            <div class="parallax">
                ...
                <div class="row" style="margin-top:100px;">
				    ...
				    <div class="col-lg-7 col-md-6 col-sm-12 cols-xs-12 slide-up">
					    ...
					    <iframe name="myframe" id="frame1" src="/KPsystem/functions/base/updateprofile.php"  style="display:none"></iframe>
					
					<form action="/KPsystem/functions/base/updateprofile.php" method="POST" target="myframe" onsubmit="if (!window.submitButtonClicked) return false;">
				    ...
				    <div class="col-lg-4 col-md-6 col-sm-12 cols-xs-12 slide-up">
					    
					    <center><img src="/KPsystem/plugins/images/bot2.png" alt="Profile"></center>
                ...
                <div class="row">
				    ...
				    <div class="col-lg-3 col-md-3 col-sm-12 cols-xs-12" style="">
