<?php
/**
 * This template displays Team Leader History
 * 
 * Template Name: Team Leader History
 */
 if (!session_id()) {
    session_start();
}
...
$sql = "SELECT count(id) FROM coach WHERE tl_userid='$user_id'";
...
$sql = "SELECT * FROM coach WHERE tl_userid='$user_id' LIMIT $offset, $rec_limit";
...
$count = 0;
                        ...
                        while($row = mysqli_fetch_assoc($result)) : $result;
								...
								<tr>
									...
									<td scope="row">
									    ...
									    <form class="form-horizontal new-lg-form" id="dcfs" action="/KPsystem/team-leader-history-detailed" method="POST">
    ...
    ?>
					 ...
					 <?php
                                ...
                                <div class="col-lg-6" style="background:#ffffff;padding:20px;">
                                    <h3>No digital coaching files..</h3>
                                    <p>Once you have attended to a new QA by Team Leader you will be able to view the progress of the coaching file here..</p>
                                </div>
                                <div class="col-lg-3">
