<?php
/**
 * This template displays Consultant History
 * 
 * Template Name: Consultant History
 */
 if (!session_id()) {
    session_start();
}
...
$sql = "SELECT count(id) FROM coach WHERE con_userid='$user_id'";
...
$sql = "SELECT * FROM coach WHERE con_userid='$user_id' LIMIT $offset, $rec_limit";
                        ...
                        while($row = mysqli_fetch_assoc($result)) : $result;
								...
								<tr>
									...
									<td scope="row">
									    ...
									    <form class="form-horizontal new-lg-form" id="dcfs" action="/KPsystem/consultant-history-detailed" method="POST">
    ...
    ?>
					 ...
					 <?php
                                ...
                                <div class="col-lg-6" style="background:#ffffff;padding:20px;margin-top:50px;border-radius:10px;">
                                    <center><h3>No digital coaching files..</h3></center>
                                    <center><p>Once you have attended to a new team leader submission you will be able to view the progress of the coaching file here..</p></center>
                                </div>
                                <div class="col-lg-3">
