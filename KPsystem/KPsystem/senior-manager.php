<?php
/**
 * This template displays Senior Manager
 * 
 * Template Name: Senior Manager
 */
 if (!session_id()) {
    session_start();
}
							...
							<table id="all_users" class="table table-hover manage-u-table" style="border-radius:10px;">
								<thead>
									<tr>
										...
										<th scope="col" style="color:#000000;">QA Email</th>
										<th scope="col" style="color:#000000;">Team Leader Username</th>
										<th scope="col" style="color:#000000;">Team Leader Email</th>
										<th scope="col" style="color:#000000;">Consultant Username</th>
										<th scope="col" style="color:#000000;">Consultant Email</th>
                        ...
                        while($row = mysqli_fetch_assoc($result)) : $result;
								...
								<tr>
									...
									<td scope="row">
									    ...
									    <form class="form-horizontal new-lg-form" id="dcfs" action="/keen-perform/senior-manager-detailed" method="POST">
