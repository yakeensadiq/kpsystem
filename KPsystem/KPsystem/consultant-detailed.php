<?php
/**
 * This template displays Consultant Detailed
 * 
 * Template Name: Consultant Detailed
 */
  if (!session_id()) {
    session_start();
}
...
<head>
    ...
    <title>Consultant | KeenPerform</title>
...
<div class="col-lg-6" style="background:#ffffff;border-radius:10px;box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);padding-top:20px;padding-bottom:20px;margin-bottom:20px;margin-top:20px;">
    ...
    <center><h3>Consultant Optional Notes</h3></center>
    
    <iframe name="myframe2" id="frame2" src="/KPsystem/functions/coach/consultant.php" style="display:none"></iframe>
						    
	<form class="form-horizontal new-lg-form" action="/KPsystem/functions/coach/consultant.php" method="POST" target="myframe2">
						        
    <div class="form-group ">
        <div class="col-xs-12">
            <textarea class="form-control" type="text" rows="4" cols="50" name="con_notes" required="" placeholder=""></textarea>
    ...
    <div class="form-group m-t-20">
        <div class="col-xs-6">
            <p>Consultant Username: <?php echo $username; ?></p>
        </div>
         <div class="col-xs-6">
             <input type="checkbox" id="escalate" name="escalate" value="escalate" style="margin-bottom:20px;"> Escalate to Senior Manager               
    ...
    <script>
                        function myFunction2() {
                            ...
                            if (confirm("Notes submitted successfully..") == true) {
                                ...
                                location.replace("/KPsystem/consultant");
