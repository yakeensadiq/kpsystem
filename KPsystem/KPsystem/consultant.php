<?php
/**
 * This template displays Consultant
 * 
                        ...
                        while($row = mysqli_fetch_assoc($result)) : $result;
								...
								<tr>
									...
									<td scope="row">
									    ...
									    <form class="form-horizontal new-lg-form" id="dcfs" action="/KPsystem/consultant-detailed" method="POST">
    ...
    ?>
					 ...
					 <?php
                                ...
                                <div class="col-lg-6" style="background:#ffffff;padding:20px;margin-top:50px;border-radius:10px;">
                                    ...
                                    <center><p>All new submissions from team leaders will appear here..</p></center>
                                </div>
                                <div class="col-lg-3">
